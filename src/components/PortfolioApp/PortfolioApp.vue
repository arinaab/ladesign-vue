    ...
    export default {
        ...
        data () {
            return {
                ...
                for: ['молодой мужчина', 'молодая девушка', 'семейная пара', 'молодой мужчина', 'молодая девушка',
                'семейная пара', 'семейная пара', 'молодая девушка', 'молодой мужчина', 'молодой мужчина'],
                area: ['60', '60', '100', '49', '60', '100', '60', '59', '60', '42'],
                moreItems: false,
                active: false,
                activeLink: ''
            }
